...
CREATE TABLE IF NOT EXISTS locker_boxes (
    ...
    code1_deliver TEXT,				 -- 4 digits for the delivery delivery guy
    code1_pickup TEXT,                           -- 4-digit code to open (customer)
    code2_pickup TEXT,                           -- Second 4-digit code to open (buisness)
    ...
    customer_email TEXT,			 -- Email of the customer picking up
...
('Suburban Hub', 'Local Deliveries Co.', 48.8789, 2.2945, '8:00 AM - 10:00 PM', 'online', 'empty', 4, 1, 3),
('Airport Terminal A', 'Global Parcels', 49.0097, 2.5479, '24/7', 'maintenance', 'full', 2, 0, 2),
...
(1, 30, 30, 30, 27000, 'full', 'Amazon', '2025-06-23 10:00:00', '2025-06-25 10:00:00', '0101', '1234', '5678', 'working', 'Alice Wonderland', '0701234567', 'Smartphone Case', 'Alice@gmail.com'),
(1, 20, 40, 25, 20000, 'full', 'Zalando', '2025-06-24 11:30:00', '2025-06-26 11:30:00', '0101', '9876', '5432', 'working', 'Bob The Builder', '0709876543', 'Running Shoes', 'Bob@gmail.com'),
(1, 40, 35, 30, 42000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(1, 15, 20, 20, 6000, 'reserved', 'eBay', '2025-06-24 15:00:00', '2025-06-27 15:00:00', '0101', '1111', '2222', 'working', 'Charlie Chaplin', '0701122334', 'Collectable Figure', 'Charlie@gmail.com'),
(1, 25, 25, 25, 15625, 'full', 'AliExpress', '2025-06-23 09:00:00', '2025-06-25 09:00:00', '0101', '3333', '4444', 'working', 'Diana Prince', '0705566778', 'Wireless Earbuds', 'Diana@gmail.com');

-- Locker 2: Suburban Hub (locker_id=2) - all empty for easy testing of adding new items
INSERT INTO locker_boxes (locker_id, height, width, length, volume, status, ecommerce_name, occupied_from, occupied_to, code1_open, code2_open, box_health, customer_name, customer_phone, parcel_name) VALUES
(2, 30, 30, 30, 27000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(2, 20, 40, 25, 20000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(2, 40, 35, 30, 42000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(2, 25, 25, 25, 15625, 'full', 'MyBooks', '2025-06-24 10:00:00', '2025-06-26 10:00:00', '0101', '8888', '9999', 'working', 'John Doe', '0711223344', 'Textbook', 'John@gmail.com');

-- Locker 3: Airport Terminal A (locker_id=3) - all full, under maintenance
INSERT INTO locker_boxes (locker_id, height, width, length, volume, status, ecommerce_name, occupied_from, occupied_to, code1_open, code2_open, box_health, customer_name, customer_phone, parcel_name) VALUES
(3, 30, 30, 30, 27000, 'full', 'DHL', '2025-06-20 08:00:00', '2025-06-22 08:00:00', '0101', '0000', '1000', 'maintenance', 'Eve Harrington', '0709988776', 'Travel Documents', 'Eve@gmail.com'),
(3, 20, 40, 25, 20000, 'full', 'UPS', '2025-06-20 09:00:00', '2025-06-22 09:00:00', '0101', '2000', '3000', 'maintenance', 'Frankenstein Monster', '0704433221', 'Medical Supplies', 'Frank@gmail.com');

-- Locker 4: University Campus (locker_id=4)
INSERT INTO locker_boxes (locker_id, height, width, length, volume, status, ecommerce_name, occupied_from, occupied_to, code1_open, code2_open, box_health, customer_name, customer_phone, parcel_name) VALUES
(4, 25, 25, 25, 15625, 'full', 'Bookworm', '2025-06-23 14:00:00', '2025-06-26 14:00:00', '0101', '4321', '8765', 'working', 'Grace Hopper', '0708877665', 'Laptop Charger', 'Grace@gmail.com'),
(4, 30, 30, 30, 27000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(4, 20, 40, 25, 20000, 'full', 'Campus Supplies', '2025-06-24 09:00:00', '2025-06-25 09:00:00', '0101', '5678', '1234', 'working', 'Harry Potter', '0703322110', 'Art Supplies', 'Harry@gmail.com');

-- Locker 5: Shopping Mall North (locker_id=5) - all empty, offline
INSERT INTO locker_boxes (locker_id, height, width, length, volume, status, ecommerce_name, occupied_from, occupied_to, code1_open, code2_open, box_health, customer_name, customer_phone, parcel_name) VALUES
(5, 30, 30, 30, 27000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(5, 20, 40, 25, 20000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL);
...
INSERT INTO locker_boxes (locker_id, height, width, length, volume, status, ecommerce_name, occupied_from, occupied_to, code1_open, code2_open, box_health, customer_name, customer_phone, parcel_name) VALUES
(6, 25, 25, 25, 15625, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(6, 30, 30, 30, 27000, 'reserved', 'Shopify', '2025-06-25 10:00:00', '2025-06-28 10:00:00', '0101', '5555', '6666', 'working', 'Isabel Jenkins', '0701239876', 'Handmade Mug', 'Isabel@gmail.com'),
(6, 20, 40, 25, 20000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'working', NULL, NULL, NULL),
(6, 35, 35, 35, 42875, 'full', 'Etsy', '2025-06-24 18:00:00', '2025-06-26 18:00:00', '0101', '7777', '8888', 'working', 'Jack Sparrow', '0704561234', 'Custom Artwork', 'Jack@gmail.com'),
(6, 15, 20, 20, 6000, 'empty', NULL, NULL, NULL, NULL, NULL, NULL,'maintenance', NULL, NULL, NULL);
