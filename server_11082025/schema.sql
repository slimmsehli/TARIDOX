...
-- new table parcel table
CREATE TABLE IF NOT EXISTS parcels (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    ecommerce_id INTEGER NOT NULL,
    tracking_number TEXT UNIQUE NOT NULL,
    status TEXT NOT NULL,
    destination_locker_id INTEGER,
    size TEXT,
    FOREIGN KEY (ecommerce_id) REFERENCES ecommerces (id),
    FOREIGN KEY (destination_locker_id) REFERENCES lockers (locker_id)
);
...
('Beja2', 'Aziza ksar bardo.', 36.7351543581828, 9.178206597350563, '24/7', 'online', 'has some space', 20, 5, 15),
('Beja1', 'Monoprix Beja.', 36.72651484700211, 9.185081099056067, '8:00 AM - 10:00 PM', 'online', 'empty', 15, 0, 15),
('Tunis1', 'Monoprix Bardo', 36.81026595630835, 10.137893136056425, '24/7', 'maintenance', 'full', 10, 10, 0),
('Tunis2', 'Monoprix Bab Souikag', 36.80559298241411, 10.171023783226184, '6:00 AM - Midnight', 'online', 'has some space', 25, 10, 15),
('Manouba1', 'Monoprix Ksar Said', 36.8126710522684, 10.114804681379816, '9:00 AM - 9:00 PM', 'offline', 'empty', 12, 0, 12),
('Ben Arous1', 'Monoprix Mourouj 2', 36.74412858244919, 10.196369291596163, '9:00 AM - 9:00 PM', 'offline', 'empty', 12, 0, 12),
('Bizert1', 'Monoprix Bizert', 37.272463397645254, 9.871803031238828, '9:00 AM - 9:00 PM', 'offline', 'empty', 12, 0, 12),
('Tabarka1', 'Monoprix Tabarka', 36.954614569549015, 8.75994674497272, '9:00 AM - 9:00 PM', 'offline', 'empty', 12, 0, 12),
('Jendouba1', 'Monoprix Jendouba', 36.50259332297461, 8.777891949174647, '9:00 AM - 9:00 PM', 'offline', 'empty', 12, 0, 12);
